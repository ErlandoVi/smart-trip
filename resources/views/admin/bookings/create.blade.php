            ...
            <div class="card-body">
                <form action="{{ route('admin.bookings.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="booking_code" placeholder="{{ __('Kode Booking') }}" name="booking_code" value="{{ old('booking_code') }}" required />
                    </div>
                    <div class="form-group">
                        <label for="price_before_tax">{{ __('Price') }}</label>
                        <input type="text" class="form-control" id="price_before_tax" placeholder="{{ __('Harga Sebelum Pajak') }}" name="price_before_tax" value="{{ old('price_before_tax') }}" required />
                    </div>
                    <div class="form-group">
                        <label for="tax">{{ __('Pajak') }}</label>
                        <input type="text" class="form-control" id="tax" placeholder="{{ __('Pajak') }}" name="tax" value="{{ old('tax') }}" required />
                    </div>
                    <div class="form-group">
                        <label for="total_price">{{ __('Total Price') }}</label>
                        <input type="text" class="form-control" id="total_price" placeholder="{{ __('Harga Total') }}" name="total_price" value="{{ old('total_price') }}" required />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="latest_order_status" placeholder="{{ __('Status Order') }}" name="latest_order_status" value="{{ old('latest_order_status') }}" required />
                    </div>
