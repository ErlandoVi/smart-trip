        ...
        <div class="card shadow">
            <div class="card-header">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">{{ __('create package') }}</h1>
            ...
            <div class="card-body">
                <form action="{{ route('admin.packages.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="package_name" placeholder="{{ __('Nama Paket') }}" name="package_name" value="{{ old('package_name') }}" required />
                    </div>
                    <div class="form-group">
                        <label for="quantity">{{ __('Quantity') }}</label>
                        <input type="number" class="form-control" id="quantity" placeholder="{{ __('Quantity') }}" name="quantity" value="{{ old('quantity') }}" required />
                    </div>
                    <div class="form-group">
