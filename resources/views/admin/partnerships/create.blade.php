        ...
        <div class="card shadow">
            <div class="card-header">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">{{ __('create partnership') }}</h1>
            ...
            <div class="card-body">
                <form action="{{ route('admin.partnerships.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="partner_name" placeholder="{{ __('Nama Partner') }}" name="partner_name" value="{{ old('partner_name') }}" required />
                    </div>
                    <div class="form-group">
                        <label for="partner_type">{{ __('Partner Type') }}</label>
                        <input type="text" class="form-control" id="partner_type" placeholder="{{ __('Tipe Partner') }}" name="partner_type" value="{{ old('partner_type') }}" required />
                    </div>
                    <div class="form-group">
                        <label for="partner_address">{{ __('Partner Address') }}</label>
                        <input type="text" class="form-control" id="partner_address" placeholder="{{ __('Alamat Partner') }}" name="partner_address" value="{{ old('partner_address') }}" required />
                    </div>
                    <div class="form-group">
